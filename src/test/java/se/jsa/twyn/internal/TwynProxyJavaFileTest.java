...
public class TwynProxyJavaFileTest {
	...
	public void generatesCorrectCode() throws Exception {
		System.out.println(TwynProxyJavaFile.create(Offspring.class, TwynProxyClassTemplates.create(), new TwynContext(new ObjectMapper(), new TwynProxyClassBuilder(), () -> new CachePolicyNone()))
			.getCode());
	}
